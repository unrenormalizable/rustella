...
$map = @{}; gc -Raw "D:\src\u\s\lib\src\opcodes.json" | ConvertFrom-Json | sort -Property opc | % { $map[$_.opc] = '/* 0x{0:x2} */ OpCodeInfo {{ addressing: "{1}", assembler: "{2}", bytes: {3}}},' -f ($_.opc, $_.addressing, $_.assembler, $_.bytes, $_.cycl{}", }},' -f ($_.opc, $_.addressing, $_.assembler, $_.bytes, es) }
0..0xff | % { $opc = "{0:X2}" -f $_; if ($map.Contains($opc)) { "    {0}" -f $map[$opc] } else { '    /* 0x{0} */
 OpCodeInfo {{ addressing: "?", assembler: "???", bytes: 1", cycles_str: "", },' -f $op0", cycles_str: "", },'c } }
*/
...
pub const ALL: &[OpCodeInfo; 0x1_00] = &[
    ...
    /* 0x10 */ OpCodeInfo { addressing: "rel", assembler: "BPL oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0x11 */ OpCodeInfo { addressing: "(ind),Y", assembler: "ORA (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0x19 */ OpCodeInfo { addressing: "abs,Y", assembler: "ORA oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x1D */ OpCodeInfo { addressing: "abs,X", assembler: "ORA oper,X", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x30 */ OpCodeInfo { addressing: "rel", assembler: "BMI oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0x31 */ OpCodeInfo { addressing: "(ind),Y", assembler: "AND (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0x39 */ OpCodeInfo { addressing: "abs,Y", assembler: "AND oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x3D */ OpCodeInfo { addressing: "abs,X", assembler: "AND oper,X", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x50 */ OpCodeInfo { addressing: "rel", assembler: "BVC oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0x51 */ OpCodeInfo { addressing: "(ind),Y", assembler: "EOR (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0x59 */ OpCodeInfo { addressing: "abs,Y", assembler: "EOR oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x5D */ OpCodeInfo { addressing: "abs,X", assembler: "EOR oper,X", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x70 */ OpCodeInfo { addressing: "rel", assembler: "BVS oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0x71 */ OpCodeInfo { addressing: "(ind),Y", assembler: "ADC (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0x79 */ OpCodeInfo { addressing: "abs,Y", assembler: "ADC oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x7D */ OpCodeInfo { addressing: "abs,X", assembler: "ADC oper,X", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0x90 */ OpCodeInfo { addressing: "rel", assembler: "BCC oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0x91 */ OpCodeInfo { addressing: "(ind),Y", assembler: "STA (oper),Y", bytes: 2, cycles: "6", },
    ...
    /* 0xB0 */ OpCodeInfo { addressing: "rel", assembler: "BCS oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0xB1 */ OpCodeInfo { addressing: "(ind),Y", assembler: "LDA (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0xB9 */ OpCodeInfo { addressing: "abs,Y", assembler: "LDA oper,Y", bytes: 3+1, cycles: "4+p", },
    /* 0xBA */ OpCodeInfo { addressing: "impl", assembler: "TSX", bytes: 1, cycles: "2", },
    /* 0xBB */ OpCodeInfo { addressing: "?", assembler: "???", bytes: 1, cycles: "0", },
    /* 0xBC */ OpCodeInfo { addressing: "abs,X", assembler: "LDY oper,X", bytes: 3+1, cycles: "4+p", },
    /* 0xBD */ OpCodeInfo { addressing: "abs,X", assembler: "LDA oper,X", bytes: 3+1, cycles: "4+p", },
    /* 0xBE */ OpCodeInfo { addressing: "abs,Y", assembler: "LDX oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0xD0 */ OpCodeInfo { addressing: "rel", assembler: "BNE oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0xD1 */ OpCodeInfo { addressing: "(ind),Y", assembler: "CMP (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0xD9 */ OpCodeInfo { addressing: "abs,Y", assembler: "CMP oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0xDD */ OpCodeInfo { addressing: "abs,X", assembler: "CMP oper,X", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0xF0 */ OpCodeInfo { addressing: "rel", assembler: "BEQ oper", bytes: 2+1, cycles: "2+t+p", },
    /* 0xF1 */ OpCodeInfo { addressing: "(ind),Y", assembler: "SBC (oper),Y", bytes: 2+1, cycles: "5+p", },
    ...
    /* 0xF9 */ OpCodeInfo { addressing: "abs,Y", assembler: "SBC oper,Y", bytes: 3+1, cycles: "4+p", },
    ...
    /* 0xFD */ OpCodeInfo { addressing: "abs,X", assembler: "SBC oper,X", bytes: 3+1, cycles: "4+p", },
