...
;---------------------------------------
        ...
        sta CTRLPF          ; 3 42
        ldy #ARENA_HEIGHT+1 ; 2 45 - the arena will be 180 scanlines (from 0-89)*2
        sta WSYNC           ; 3 48 - gab between timer and Arena
;---------------------------------------                   
...
NotReset:
        ...
        lda #0
        sta GameState   ; clear D7 to signify Game Over Ê Ê Ê Ê
